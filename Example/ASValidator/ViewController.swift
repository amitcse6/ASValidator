...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        textView.register(asValidator, usernameErrorLabel,[ASVRequiredRule(), ASVMinLengthRule(5), ASVDateRule("2022-12-22", "yyyy-MM-dd", .minOrEqual, nil)], "TextView", nil, ASVErrorProps([textView, textView], nil, textView.backgroundColor, nil), "Any Object", "1")
        textView.text = "2022-12-21"
